...
(**)
(*(*Bottone che mostra gli high score: quando un punteggio viene salvato viene aggiunto al file locale chiamato "punteggi.txt" che viene recuperato da questo pulsante e stampato a schermo. Prima di stampare viene cancellata l'ultima cella di output, in modo tale da non avere ripetizioni e di avere i punteggi pi\[UGrave] aggiornati*)*)
