...
(*(* :Copyright:Un Nome 2022*)*)
(*(* :Package Version:1*)*)
(*(* :Mathematica Version:13*)*)
(*(* :History:Versions 15,May 2022*)*)
...
(**)
(*(*instanziamo una variabile per conteggiare il numero di tiri per turno*)*)
(*turno=0;*)
(**)
...
(*reset:={dice1=0,dice2=0,dice3=0,dice4=0,dice5=0,girato=0,dice1Lock=False,dice2Lock=False,dice3Lock=False,dice4Lock=False,dice5Lock=False,girato=0,d1="Libero",d2="Libero",d3="Libero",d4="Libero",d5="Libero",color1=Green,color2=Green,color3=Green,color4=Green,color5=Green,flagPunteggioSelezionato=False,turno++};*)
(**)
