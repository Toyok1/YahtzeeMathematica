...
(**)
(*(*Bottone per il salvataggio del punteggio. Diventa cliccabile solo dopo aver giocato una partita intera, ovvero quando tutte le combinazioni sono state riempite. Quando il pulsante viene cliccato, la funzione crea il file "punteggi.txt" (se gi\[AGrave] non esiste) e aggiunge il punteggio realizzato al file. Se invece il file esiste gi\[AGrave], semplicemente viene aggiunto il punteggio. La funzione funzCreaStringa che fa la maggior parte del lavoro verr\[AGrave] spiegata pi\[UGrave] in basso, alla sua definizione*)*)
